    ...
    info: [
      {
        title: 'Front-End',
        icons: [
          <span title="HTML"><FaHtml5 style={{color: '#cc5104'}}/></span>,
          <span title="CSS"><FaCss3 style={{color: '#0447cc'}}/></span>,
          <span title="Bootstrap"><FaBootstrap style={{color: '#bd07e6'}}/></span>,
          <span title="Tailwind"><SiTailwindcss style={{color: 'lightblue', background: 'white'}}/></span>,
          <span title="Framer-motion"><TbBrandFramerMotion  style={{color: '#8507e6'}}/></span>,
          <span title="JavaScript"><FaJs style={{color: '#e6e207', background: 'black'}}/></span>,
          <span title="React.js"><FaReact style={{color: 'lightblue', background: 'white'}}/></span>,
      ...
      },
      {
        title: 'Back-End',
        icons: [
          <span title="Python"><SiPython style={{color: '#061e97', background: 'white'}}/></span>, 
          <span title="Django"><SiDjango style={{color: '#069742'}}/></span>, 
          <span title="Java"><FaJava style={{color: 'red'}}/></span>, 
          <span title="SpringBoot"><BiLogoSpringBoot style={{ color: '#069742' }} /></span>
        ],
      },
      {
        title: 'DataBase',
        icons: [
          <span title="MySQL"><SiMysql style={{color: '#061e97', background: 'white'}}/></span>, 
          <span title="SQLite"><SiSqlite style={{color: 'lightblue', background: 'white'}}/></span>, 
        ],
      },
    ],
  },
                    ...
                    {aboutData[index].info.map((item, itemIndex)=>{
                      return (
                        <div key={itemIndex} className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center">
                          ...
                          <div className="flex gap-x-4">{item.icons?.map((icon, itemIndex)=>{
