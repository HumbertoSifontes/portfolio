...
import EgbeSlider from "@/components/EgbeSlider";
      ...
      <div className="h-full pt-8 pb-36">
        <div className="container mx-auto sm-screen-w">
          <div className="flex flex-col xl:flex-row gap-x-8">
            <div className="text-center flex xl:max-w-[65%] flex-col xl:text-left mb-4 xl:mb-0">
              <div className="w-full">
                <motion.h3
                  ...
                  className="h3 texto"
                >
                  Plataforma de Templo Religioso
                ...
                <motion.div
                  ...
                  <p className='texto sm-screen-text-left'>
                    ...
                    , resultando en una SPA (Single Page Application). Para su
                    estructura, utilicé Bootstrap, y para dar efectos dinámicos a
                    los elementos cuando entran en el viewport por primera vez,
                    usé Framer-Motion.
                    <br />
                    <br />
                  </p>
            ...
            >
              <Link
                href={"https://egbeiworiaweda.netlify.app/"}
                target="_blank"
